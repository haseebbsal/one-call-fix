            ...
            <div className="flex gap-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                {getTradePersonQuery.data?.data.data && <div className="flex gap-4">
                  <BaseButton as="link" target="_blank" extraClass="!bg-transparent !text-color-9 !border-color-9 border-2" link={getTradePersonQuery.data?.data.data.profile.externalReviews}>
                    External Reviews
                  </BaseButton>
                  <BaseButton as="link" target="_blank" extraClass="!bg-transparent !text-color-9 !border-color-9 border-2" link={getTradePersonQuery.data?.data.data.profile.website}>
                    Website
                  </BaseButton>
                </div>}
