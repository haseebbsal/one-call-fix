...
//   const cardQuery=useQuery(['card'],()=>axiosInstance.get('/payment/card'))
...
//                 preview={true}
//                 cvc="•••"
//                 expiry={`${cardQuery.data?.data.data.expiryMonth}/${cardQuery.data?.data.data.expiryYear}`}
//                 name={cardQuery.data?.data.data.country}
//                 number={`•••• •••• •••• ${cardQuery.data?.data.data.last4}`}
//                 // focused="number"
//                 issuer={cardQuery.data?.data.data.brand}
//             />
